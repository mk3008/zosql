...
describe('MainContentViewModel', () => {
  ...
  describe('Commands', () => {
    ...
    it('should handle query execution errors', async () => {
      const { commandExecutor } = await import('@core/services/command-executor');
      (commandExecutor.execute as unknown as { mockRejectedValue: (error: Error) => void }).mockRejectedValue(new Error('SQL error'));
    ...
    it('should format query', async () => {
      const { commandExecutor } = await import('@core/services/command-executor');
      (commandExecutor.execute as unknown as { mockResolvedValue: (value: string) => void }).mockResolvedValue('SELECT\n  *\nFROM\n  users');
